...
$api_key = "AIzaSyBJbGZ95TkUrYarQhNzO833Eyr7XtPm9Sw";

$url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=" . $api_key;

$prompt_iot = "
Você é um assistente virtual que explica conceitos básicos de enfermagem com IoT.
Fale sempre de forma bem resumida(no máximo 3 frases).
Use apenas texto simples, sem negrito, sem esteristicos e sem formatação.
